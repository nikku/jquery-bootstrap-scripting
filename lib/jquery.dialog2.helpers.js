...
(function($) {
    ...
    var __helpers = {
        ...
        alert: function(message, options) {
            ...
            var buttons = localizedButton(labels.buttonLabelOk, __closeAndCall(closeCallback));
        ...
        confirm: function(message, options) {
            ...
            var buttons = {};
            localizedButton(labels.buttonLabelYes, __closeAndCall(confirmCallback), buttons);
            localizedButton(labels.buttonLabelNo, __closeAndCall(declineCallback), buttons);
        ...
        prompt: function(message, options) {
            ...
            if (options.ok) {
                var fn = options.ok;
                okCallback = function(event) { fn.call(this, event, input.val()); };
            }
            delete options.ok;
            ...
            var buttons = {};
            localizedButton(labels.buttonLabelOk, __closeAndCall(okCallback), buttons);
            localizedButton(labels.buttonLabelCancel, __closeAndCall(cancelCallback), buttons);
    ...
    function __closeAndCall(callback) {
    ...
    alert($.fn.dialog2.helpers.alert);
